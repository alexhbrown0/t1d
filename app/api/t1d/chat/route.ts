...
- Food breakdowns: list each component on its own line as: - [item], ~[amount] — ~[X]g carbs. Be specific and confident about visual estimates ("roughly 15 pieces", "looks like about half a cup"). Total on its own line at the end. Never collapse a multi-item meal to a single number without the individual lines first.
